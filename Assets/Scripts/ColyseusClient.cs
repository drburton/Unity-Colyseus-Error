...
*/
	...
	void OnEntityAdd(Entity entity, string key)
	{
		...
		Debug.Log("Player add! x => " + entity.xPos + ", z => " + entity.zPos);

		cube.transform.position = new Vector3(entity.xPos, 0, entity.zPos);
		...
		{
			cube.transform.Translate(new Vector3(entity.xPos, 0, entity.zPos));
		};
	}
